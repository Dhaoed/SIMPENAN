...
<header>
    <div class="header-container">
        ...
        <main>
            <div class="container">
                <h2 class="service-title">Pilih pelayanan yang Anda butuhkan:</h2>
                <div class="services-vertical">
                    <a href="formulir_sktm.php" class="service-item">
                        <div class="service-icon">📄</div>
                        <div class="service-text">
                            <h3>Pengurusan SKTM</h3>
                            <p>Surat Keterangan Tidak Mampu</p>
                        </div>
                        <div class="arrow">›</div>
                    </a>
                    <a href="formulir_dispensasi_nikah.php" class="service-item">
                        <div class="service-icon">💍</div>
                        <div class="service-text">
                            <h3>Dispensasi Uang Nikah</h3>
                            <p>Pengajuan dispensasi biaya nikah</p>
                        </div>
                        <div class="arrow">›</div>
                    </a>
                    <a href="formulir_ahli_waris.php" class="service-item">
                        <div class="service-icon">👥</div>
                        <div class="service-text">
                            <h3>Pengurusan Ahli Waris</h3>
                            <p>Surat keterangan ahli waris</p>
                        </div>
                        <div class="arrow">›</div>
                    </a>
                    <a href="formulir_uang_duka.php" class="service-item">
                        <div class="service-icon">💰</div>
                        <div class="service-text">
                            <h3>Penerima Uang Duka</h3>
                            <p>Pengajuan bantuan uang duka</p>
                        </div>
                        <div class="arrow">›</div>
                    </a>
                    <a href="faq_page.php" class="service-item">
                        <div class="service-icon">📋</div>
                        <div class="service-text">
                            <h3>Pelayanan Lainnya</h3>
                            <p>Layanan tambahan lainnya</p>
                        </div>
                        <div class="arrow">›</div>
                    </a>
                </div>
