...
$jenis = isset($_GET['jenis']) ? $_GET['jenis'] : 'Umum';
$tableName = $jenis;
...
if (isset($_GET['year']) && !empty($_GET['year'])) {
    ...
    $baseQuery .= " AND YEAR(STR_TO_DATE(tanggal, '%Y-%m-%d')) = '$year'";
}
...
<div class="content">
    ...
    <h1 style="text-align: left; font-weight:800; margin-top: 40px; margin-bottom: 40px;">PELAYANAN SKTM - UMUM</h1>
...
$('#btnSimpanEdit').click(function() {
    ...
    $('.download-berkas').click(function() {
        var id = $(this).data('id');
        window.location.href = 'download_berkas_umum.php?id=' + id;
    });
});
