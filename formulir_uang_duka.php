...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $tanggal_wafat = isset($_POST['tanggal_wafat']) ? bersihkanInput($_POST['tanggal_wafat']) : '';
        $ahli_waris = isset($_POST['ahli_waris']) ? bersihkanInput($_POST['ahli_waris']) : '';
        $alamat = isset($_POST['alamat']) ? bersihkanInput($_POST['alamat']) : '';
        $kelurahan = isset($_POST['kelurahan']) ? bersihkanInput($_POST['kelurahan']) : '';
        
        // Validasi data yang diperlukan
        $errors = [];
        if (empty($nama)) $errors[] = "Nama harus diisi";
        if (empty($tanggal_wafat)) $errors[] = "Tanggal Wafat harus diisi";
        ...
        $query = "INSERT INTO formulir_uang_duka (nama, tanggal_wafat, ahli_waris, alamat, kelurahan, dokumen) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        echo "<script>
            alert('Permohonan Penerima Uang Duka berhasil dikirim!');
...
<head>
    ...
    <title>Formulir Permohonan Penerima Uang Duka - SIMPENAN</title>
...
<header>
    ...
    <main>
        <div class="form-container">
            <h2 class="form-title">Formulir Permohonan Penerima Uang Duka</h2>
                ...
                <div class="form-section">
                    <h3>Data Pemohon</h3>
                    <div class="form-group">
                        <label>Nama Lengkap Almarhum/Almarhumah <span class="required">*</span></label>
                ...
                <div class="form-section">
                    <h3>Tanggal Wafat</h3>
                    <div class="form-group">
                        <label>Tanggal Wafat<span class="required">*</span></label>
                        <input type="date" class="form-control" name="tanggal_wafat" required>
                </div>
                ...
                <div class="form-section">
                    <h3>Ahli Waris</h3>
                    <div class="form-group">
                        <label>Nama Lengkap Penerima Ahli Waris<span class="required">*</span></label>
                        <textarea class="form-control" name="ahli_waris" rows="3" required></textarea>
                </div>

                <!-- Alamat -->
                <div class="form-section">
                    <h3>Alamat Ahli Waris</h3>
                    <div class="form-group">
                        <label>Alamat Ahli Waris sesuai KTP<span class="required">*</span></label>
                ...
                <div class="form-section">
                    <h3>Kelurahan</h3>
                    <div class="form-group">
                        <label>Isi sesuai KTP<span class="required">*</span></label>
