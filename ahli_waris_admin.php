...
$jenis = isset($_GET['jenis']) ? $_GET['jenis'] : 'Ahli_waris';
$tableName = $jenis;
...
// Query dasar
$baseQuery = "SELECT ID, nama, nomor_register, tanggal FROM `$tableName` WHERE 1=1";
...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    $baseQuery .= " AND (nama LIKE '%$search%' OR nomor_register LIKE '%$search%' OR tanggal LIKE '%$search%')";
}
...
<head>
    ...
    <title>Pengurusan Ahli Waris | Admin</title>
...
<div class="content">
    ...
    <h1 style="text-align: left; font-weight:800; margin-top: 40px; margin-bottom: 40px;">Daftar Pengurusan Ahli Waris</h1>
        ...
        <thead>
            <tr>
                ...
                <th style="width: 15%;">Nomor Register</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>
                              <div class='btn-group btn-group-sm' role='group'>
                                <button class='btn btn-secondary btn-warning edit-data mr-1' data-id='" . $row['ID'] . "' data-nama='" . htmlspecialchars($row['nama']) . "' data-nomor_register='" . htmlspecialchars($row['nomor_register']) . "' data-tanggal='" . $row['tanggal'] . "'title='Edit'><i class='fas fa-edit'></i></button>
      ...
      <div class="modal-body">
        <form id="formTambahData">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nomorRegister" name="nomorRegister" required>
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="editNomorRegister">Nomor Register</label>
            <input type="text" class="form-control" id="editNomorRegister" name="nomorRegister" required>
        </div>
        <div class="form-group">
...
$(document).ready(function() {
  $('#btnSimpan').click(function() {
    ...
    $.ajax({
      url: 'tambah_data_ahli_waris.php',
      type: 'POST',
      data: formData,
...
$(document).ready(function() {$(document).ready(function() {
    ...
    var nomorRegister = $(this).data('nomor_register');
    var tanggal = $(this).data('tanggal');

    $('#editId').val(id);
    $('#editNama').val(nama);
    $('#editNomorRegister').val(nomorRegister);
    ...
    $('#btnSimpanEdit').click(function() {
        ...
        $.ajax({
            url: 'update_data_ahli_waris.php',
            type: 'POST',
            data: formData,
            success: function(response) {
...
$(document).ready(function() {
    ...
    $.ajax({
        url: 'upload_dokumen_ahli_waris.php',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
    ...
    $('.download-berkas').click(function() {
        var id = $(this).data('id');
        window.location.href = 'download_berkas_ahli_waris.php?id=' + id;
    });
});
