...
<div class="content">
    ...
    <h1 style="text-align: left; font-weight:800; margin-top: 40px; margin-bottom: 40px;">PELAYANAN SKTM - KESEHATAN</h1>
...
$(document).ready(function() {
    ...
    $.ajax({
        url: 'upload_dokumen_kesehatan.php',
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
    ...
    $('.download-berkas').click(function() {
        var id = $(this).data('id');
        window.location.href = 'download_berkas_kesehatan.php?id=' + id;
    });
});
